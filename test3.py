...
class DiscoRewardTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # Assuming the model now outputs both mean and log variance
        mu_chosen, log_var_chosen = rewards_chosen[0], rewards_chosen[1]
        mu_rejected, log_var_rejected = rewards_rejected[0], rewards_rejected[1]

        # Calculate the preference probability
